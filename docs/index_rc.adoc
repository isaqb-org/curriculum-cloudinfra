...
image:https://img.shields.io/github/commits-since/isaqb-org/curriculum-cloudinfra/latest.svg[]
|===
| Version | HTML | PDF
...
- link:https://github.com/isaqb-org/curriculum-cloudinfra/blob/main/CHANGELOG.md[CHANGELOG.md on GitHub]
