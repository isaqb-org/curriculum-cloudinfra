...
Development Environment, Application Lifecycle Management, Formen von Deployments wie Rolling-, Canary- und Blue/Green Deployment, Backup und Restore, Logging, Monitoring, Alerting, Distributed Tracing, Mean Time To Recovery (MTTR)
