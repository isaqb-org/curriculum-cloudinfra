...
Das Erarbeiten, Bewerten oder Vermitteln konkreter Lösungsansätze für dieses Lernziel ist optional.
...
[[LZ-6-6]]
==== LZ 6-6: Architektur von Observability-Tools in Cloud-Umgebungen kennen und einordnen

Softwarearchitekt:innen verstehen, dass verteilte Ausführung in der Cloud besondere Anforderungen an die Architektur von Observability-Lösungen stellt.

Sie kennen architektonische Muster zur Erfassung, Weiterleitung und Verarbeitung von Telemetriedaten (Metriken, Logs, Traces) in unterschiedlichen Cloud-Betriebsumgebungen wie Container-Manager, virtuelle Maschinen und managed Plattformen.

Sie wissen, in welchen Fällen Push- bzw. Pull-Verfahren für den Versand von Telemetriedaten geeignet sind.

Sie kennen die Auswirkungen dieser Architekturentscheidungen auf Skalierbarkeit, Betriebsaufwand und Ausfallsicherheit.
...
Developing, evaluating, or teaching concrete solution approaches for this learning goal is optional.
...
[[LG-6-6]]
==== LG 6-6: Understand and Classify the Architecture of Observability Tools in Cloud Environments

Software architects understand that distributed execution in the cloud creates specific requirements for the architecture of observability solutions.

They are familiar with architectural patterns for collecting, forwarding, and processing telemetry data (metrics, logs, traces) in different cloud operating environments such as container managers, virtual machines, and managed platforms.

They know in which cases push and pull methods are suitable for shipping telemetry data.

They understand the impact of these architecture decisions on scalability, operational effort, and resilience.
