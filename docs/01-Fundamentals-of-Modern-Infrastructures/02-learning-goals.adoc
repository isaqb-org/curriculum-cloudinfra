...
[[LZ-1-2]]
==== LZ 1-2: Entscheidungskriterien für die Provider-Auswahl verstehen

Softwarearchitekt:innen kennen unterschiedliche Kriterien bei der Provider-Auswahl, zum Beispiel:

* Vorhandene Zertifizierungen, Verträge und Geschäftsbeziehungen
* Technische Anforderungen (Service-Angebot)
* Besondere Datenschutz- und Datensicherheitsanforderungen
* Besondere rechtliche Vorgaben für kritische Infrastrukturen
* Aktuelle politische und wirtschaftliche Rahmenbedingungen
* Mögliche Abhängigkeiten von Services und Infrastrukturen externer Parteien

Softwarearchitekt:innen können Risiken und Nachteile unterschiedlicher Provider-Optionen unter gegebenen Rahmenbedingungen (z. B. Budget, Personal, Compliance) bewerten und begründet entscheiden, welche Optionen tragbar sind.

Sie kennen das Konzept des Vendor Lock-in und können bewerten, wie sich ein Vendor Lock-in oder dessen Vermeidung auf Kosten, Komplexität und Handlungsfähigkeit auswirkt.

Softwarearchitekt:innen kennen den Begriff der digitalen Souveränität und können ihn erklären.

[[LZ-1-3]]
==== LZ 1-3: Entscheidungskriterien für die Nutzung von managed Services und self-managed Services verstehen
...
Sie kennen die Relevanz von Vendor Lock-in für die Entscheidungsfindung zwischen managed und self-managed Services.

[[LZ-1-4]]
==== LZ 1-4: Compliance und organisatorische Aspekte bei der Cloud-Architektur berücksichtigen
...
[[LZ-1-5]]
==== LZ 1-5: Verfügbarkeit, Skalierung und Performance als Anforderungsparameter beim Cloud-Architektur-Design anwenden
...
[[LG-1-2]]
==== LG 1-2: Understand Decision Criteria for Provider Selection

Software architects know different criteria for provider selection, for example:

* Existing certifications, contracts, and business relationships
* Technical requirements (service offering)
* Specific data protection and data security requirements
* Specific legal requirements for critical infrastructures
* Current political and economic constraints
* Potential dependencies on services and infrastructures of external parties

Software architects can assess risks and disadvantages of different provider options under given constraints (e.g. budget, staffing, compliance) and make well-founded decisions about which options are acceptable.

They know the concept of vendor lock-in and can assess how vendor lock-in or its avoidance affects costs, complexity, and ability to act.

Software architects know the term digital sovereignty and can explain it.

[[LG-1-3]]
==== LG 1-3: Understand Decision Criteria for the Use of Managed Services and Self-Managed Services
...
They know the relevance of vendor lock-in for decision-making between managed and self-managed services.

[[LG-1-4]]
==== LG 1-4: Incorporate Compliance and Organizational Aspects Into Cloud Architecture
...
[[LG-1-5]]
==== LG 1-5: Apply Availability, Scaling and Performance Requirements as Parameters in Cloud Architecture Design
