...
== Status 
image:https://github.com/isaqb-org/curriculum-cloudinfra/workflows/CI/badge.svg?branch=master["CI"]
image:https://img.shields.io/github/last-commit/isaqb-org/curriculum-cloudinfra/master.svg["Last commit"]
